...
$(document).ready(function() {
    ...
    $('.pokemon').on('click', function() {
      ...
      // get rid of the remaining pokemon's background
      $('#' + id).css("background", "none");
      // hide the pokemon's caption
      $('#' + id + ' .caption').hide();

      // fade out all pokemon except the one that got clicked on
      setTimeout(function() {
        $('.pokemon').not(document.getElementById(id)).fadeOut();
      ...
      // var offset = p.offset();
      //
      // $("#" + id).offset({ top: offset.top, center: offset.center})
      setTimeout(function() {
